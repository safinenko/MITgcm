...
C         Min - Minimum spins for an exchange
     ...
     &                       nSx, nSy )
       INTEGER exchangeBufLevel(  lShare4, nSx, nSy )
       INTEGER exchNReqsX(lShare4,nSx,nSy)
       INTEGER exchNReqsY(lShare4,nSx,nSy)
       INTEGER exchReqIdX(2*nSx+2*nSy,lShare4,nSx,nSy)
       INTEGER exchReqIdY(2*nSx+2*nSy,lShare4,nSx,nSy)
       INTEGER exchRecvXSpinCount(lShare4, nSx, nSy)
       INTEGER exchRecvXExchCount(lShare4, nSx, nSy)
       INTEGER exchRecvXSpinMax  (lShare4, nSx, nSy)
       INTEGER exchRecvXSpinMin  (lShare4, nSx, nSy)
       INTEGER exchRecvYSpinCount(lShare4, nSx, nSy)
       INTEGER exchRecvYExchCount(lShare4, nSx, nSy)
       INTEGER exchRecvYSpinMax  (lShare4, nSx, nSy)
       INTEGER exchRecvYSpinMin  (lShare4, nSx, nSy)
